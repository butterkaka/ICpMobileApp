 ...
 */
  constructor(public navCtrl: NavController, 
    ...
    public app : App) { //,public alertService:AlertServiceProvider
  ...
  */
  ionViewDidEnter() {
    ...
    done.then(()=>this.utilsService.hideLoading());
...
*/
  ...
  */
  async writePressureRegulatorSetupParameters() {
 ...
 */
  ...
  /** 
 * This is used to navigate to LiveTunePage
 */
  navegateToLiveTune() {
    if (this.pcmchanneldataservice.passwordFlag) {
      if (this.liveTuneCheck) {
        ...
        this.app.getRootNav().push(LiveTunePage, { deviceObject: this.deviceObject, liveTuneGraphType: 1 });
