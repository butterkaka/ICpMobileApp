  ...
  */
  ionViewDidEnter() {
    ...
    const done = new Promise((resolve, reject) =>{
      resolve(this.readRegualtorSetupParameters());
    });
...
*/
  ...
  */
  async readRegualtorSetupParameters() {
    this.operation = Constants.values.read;
    this.items = this.pcmchanneldataservice.swashAngleSetupItems;
    ...
    //this.items.forEach(element => {
      ...
      //await this.write(this.deviceObject.deviceId, this.deviceObject.serviceUUID, this.deviceObject.characteristicId, byteArray.buffer);
    //});
    }
  ...
  */
  async writeSwashAngleSetupParameters() {
    if (this.pcmchanneldataservice.passwordFlag) {
      ...
      for(let element of this.items){
        ...
        if (flag == 1) {
          ...
          this.utilsService.write(this.deviceObject.deviceId, this.deviceObject.serviceUUID, this.deviceObject.characteristicId, byteArray.buffer);
 ...
 */
  // async write(deviceID, serviceID, characteristicID, value) {
